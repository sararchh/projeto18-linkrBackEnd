...
var _metadatascraper = require('metadata-scraper'); var _metadatascraper2 = _interopRequireDefault(_metadatascraper);
...
const db = await _databasejs2.default.call(void 0, );
 ...
 async function createPost(req, res) {
    ...
    try {
        ...
        const metadata = await _metadatascraper2.default.call(void 0, url)
